...
const ChooseUs = () => {
  return (
    ...
    >
      <div className="mt-[35rem] md:mt-[30rem] lg:mt-[1rem] w-11/12 md:w-[31.688rem] md:h-[22.2rem] pl-10 pt-6 pr-20 bg-red flex flex-col rounded-md">
        ...
        <p className="md:pt-4 text-xs md:text-sm text-white font-extralight md:font-normal leading-[17.07px]">
          Our team of experienced engineers and{" "}
          <b>
            skilled craftsmen is passionate about creating cutting tools that
            deliver exceptional performance and longevity.
          </b>{" "}
          Leveraging advanced manufacturing processes and stringent quality
          control, we produce tools that withstand the rigors of demanding
        ...
        <button className="mb-4 bg-white w-[5.789rem] md:w-[8.7rem] flex items-center justify-between py-[0.3rem] md:py-[0.625rem] mt-16 rounded">
          ...
          <img src={arrowRight} alt="arrowRightBlackAltImg" className="pr-2" />
        </button>
      </div>
      <div className="  lg:h-[21.625rem] md:w-[31.688rem] flex flex-col justify-evenly md:items-start md:justify-between lg:ml-16 py-20 lg:py-[0px] gap-3 md:gap-auto">
        {checks.map((item, i) => {
          return (
            <div className="flex items-center" key={`${i}_${item}`}>
